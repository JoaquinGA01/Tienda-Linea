...
class shorts extends Controller{
    ...
    public function iniciar(){
        if(isset($_POST['Email']) && isset($_POST['Password'])){
            ...
            if(isset($_POST['Name'])){
                ...
                if($conn){
                    ...
                    if (mysqli_query($conn, $sql)) {
                        return view('shorts')->with('nombre', $nombre);
                    }
            }
            return view('shorts');
            }else{
            ...
            if($conn){
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {         
                        ...
                        return view('shorts')->with('nombre', $row["name"])->with('email', $row["id"] )->with('productos', $productos);
                    }
            ...
            $productos = buscarproductos();
            return view('shorts')->with('productos',$productos);        
        }
